...
func TestGenericList(t *testing.T) {
	FailIf(t, DoTest(
		...
		listCmd,
		doList,
		map[string]interface{}{"no-headers":true,"parsed":true,"output":"id,clones"},
		[]string{},
...
func TestGenericListTypes(t *testing.T) {
	FailIf(t, DoTest(
		...
		listCmd,
		doList,
		map[string]interface{}{"types":"vol,snap","no-headers":true,"parsed":true,"output":"type,id,clones"},
		[]string{},
		[]string{ // expected
...
func TestGenericListParameters(t *testing.T) {
	FailIf(t, DoTest(
		...
		listCmd,
		doList,
		map[string]interface{}{"recursive":true,"no-headers":true,"parsed":true,"output":"id,clones"},
